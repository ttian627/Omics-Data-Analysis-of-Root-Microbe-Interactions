...
https://github.com/ttian627/Omics-Data-Analysis-of-Root-Microbe-Interactions/blob/main/02_RNAseq/B73-exp-matrix-FPKM.txt.gz

#PCA analysis(R script)

library(ggplot2)
#read expression matrix
expr_matrix <- read.table("/home/go82tip/course/02_WGCNA/Yu2021NaturePlants/gene_counts_table_WGCNA.txt", row.names=1,header = T,check.names = FALSE)
...
data0=read.table("/home/go82tip/course/02_WGCNA/Yu2021NaturePlants/gene_counts_table_WGCNA.txt",header=T,row.names=1,sep="\t")
